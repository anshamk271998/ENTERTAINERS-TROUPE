...
public class Send_complaint extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com=(EditText)findViewById(R.id.editText17);
    ...
    public void onClick(View view) {
        final String cm=com.getText().toString();

        if(cm.length()==0)
        {
            com.setError("Missing");
            ...
            String url = "http://" + hu + ":8000/myapp/and_send_complaint/";
            ...
            StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Toast.makeText(Send_complaint.this, "Added", Toast.LENGTH_SHORT).show();
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("lid", id);
                    params.put("complaint", cm);
                    params.put("trpid", sh.getString("troupid",""));
