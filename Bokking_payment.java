...
public class Bokking_payment extends AppCompatActivity implements View.OnClickListener {
    Button btbrowse,btgo;
    TextView tv20,tv17,tv11;
    RadioButton g,a;
    int amout=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bokking_payment);
        ...
        tv17.setText("GOOGLE PAY NUMBER :"+sh.getString("phone",""));

        String am=sh.getString("amount","");
        amout=Integer.valueOf(am)/2;
        tv11.setText("Amount:"+String.valueOf(amout));
...
//////                startActivity(i);
                ...
                String url = "http://" + hu + ":8000/myapp/and_troup_payment/";
...
//                                    ed.commit();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("am", String.valueOf(amout));
