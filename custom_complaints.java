...
public class custom_complaints extends BaseAdapter {
    String[]cid,cdate,comp,rep;
    private Context context;

    public custom_complaints(Context appcontext, String[]cid1, String[]cdate1, String[]comp1, String[] rep)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            gridView=inflator.inflate(R.layout.custome_view_complaints,null);
        }
        else
        {
            gridView=(View)view;
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://" + hu + ":8000/myapp/and_delete_complaint/";
